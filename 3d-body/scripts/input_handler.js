...
o3v.InputHandler = function(win) {
  ...
  win.addEventListener('touchstart', this.handleMouseDown.bind(this), false);
  ...
  win.addEventListener('touchmove', this.handleMouseMove.bind(this), false);
  win.addEventListener('mouseout', this.handleMouseOut.bind(this), false);
  win.addEventListener('touchend', this.handleMouseOut.bind(this), false);
...
o3v.InputHandler.prototype.handleMouseDown = function(e) {
  ...
  this.lastMousePosition_ = this.getCoors(e);
  this.lastMouseDownTime_ = new Date().getTime();
  this.mouseDown_ = true;
};

o3v.InputHandler.prototype.getCoors  = function(e) {
    var coors = [];
...
o3v.InputHandler.prototype.handleMouseUp = function(e) {
  ...
  if (!suppress) {
    var coords=this.getCoors(e);
    var dx = coords[0] - this.lastMousePosition_[0];
    var dy = coords[1] - this.lastMousePosition_[1];
...
o3v.InputHandler.prototype.handleMouseMove = function(e) {
  ...
  this.lastMousePosition_ = coords;
};
